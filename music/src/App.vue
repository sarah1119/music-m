<template>
  <div id="app">
    <div class="header">
      ...
      <div class="research">搜索</div>
    </div>
    <!--遮罩-->
    <!--<transition name="fade">-->
    <div class="mask" v-if="maskShow" @click="mask()"></div>
    <!--</transition>-->
    <!--设置-->
    <transition name="left">
      <Set v-if="setShow"></Set>
      <!--<Set v-if="bIndex"></Set>-->
    </transition>
    <router-view></router-view>
    <!--底部固定-->
    <div class="fixed">
      <mt-cell :title="database[bIndex].songs" :label="database[bIndex].lyrics[7].lyric">
          <!--<router-link to="/">-->
            <img slot="icon" :src="database[bIndex].avatar" width="34" height="34" @click="songDetail">
          <!--</router-link>-->
        <!--<span>播放</span>-->
        <div>
          <span @click="last()">上一首</span>
          <span @click="play()">播放</span>
          <span @click="next()">下一首</span>
          <span @click='list()'>列表</span>
        </div>
      </mt-cell>
      <audio id='audio' preload="auto" :src='database[bIndex].src'></audio>
    </div>
    <!--列表组件-->
    <transition name="bottom">
      <List v-if="listShow"></List>
    </transition>
  </div>
</template>
...
//            songs: "阴天",
//            name: "莫文蔚",
//            src: require('@/assets/music/阴天.mp3'),
//            alltime: "04:02",
//            avatar: require('@/assets/img/mww.jpg'),
//            lyrics: [
//              {time: "00:02", lyric: "阴天"},
...
//            songs: "幸福的错觉",
//            name: "任重",
//            src: require('@/assets/music/幸福的错觉.mp3'),
//            alltime: "04:36",
//            avatar: require('@/assets/img/rz.jpg'),
...
//            id: "2", songs: "背影",
//            name: "林宥嘉",
//            src: require('@/assets/music/背影.mp3'),
//            alltime: "05:54",
//            avatar: require('@/assets/img/lyj.jpg'),
//            lyrics: [
//              {time: "00:02", lyric: "背影"},
...
//            songs: "红玫瑰",
//            name: "陈奕迅",
//            src: require('@/assets/music/红玫瑰.mp3'),
//            alltime: "04:00",
//            avatar: require('@/assets/img/cyx.jpg'),
...
//            songs: "初爱",
//            name: "杨宗纬",
//            src: require('@/assets/music/初爱.mp3'),
//            alltime: "03:53",
//            avatar: require('@/assets/img/yzw.jpg'),
...
//            songs: "情书",
//            name: "张学友",
//            src: require('@/assets/music/情书.mp3'),
//            alltime: "04.06",
//            avatar: require('@/assets/img/zxy.jpg'),
//            lyrics: [
//              {time: "00:01", lyric: "情书"},
