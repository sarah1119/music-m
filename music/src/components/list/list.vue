<template>
  <div class="list">
    <mt-cell title="随机播放" value="收藏全部" icon="more" class="list-fixed" >
      <div @click="playStyle()">icon</div>
       <div @click="collectAll">收藏全部</div>
       <div @click="deleteAll">X</div>

    </mt-cell>
    <mt-cell title="" value="" class=""></mt-cell>
    <mt-cell v-for="item in database" :title='item.songs' :key="item.id" @click.native="listItem(item)" value="X"></mt-cell>
  </div>
</template>
<script>
